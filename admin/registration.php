...
if (isset($_POST['register'])){
	...
	values(null,'$_POST[fname]','$_POST[lname]','$_POST[email]','$_POST[password]')";
	...
	<section id="register">
    	<div class="row mb-4">
      	...
      	<div class="col-md-4 m-auto-block">
        	...
        	<form action="" method="post" class="was-validated shadow-md p-4 bg-light">
            ...
            If Registered, Please <a href="index.php"> Login Here </a> 
        	</form>
      	</div>
        <div class="col-md-4"></div>
    	</div>
