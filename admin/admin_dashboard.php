            ...
            <div class="row mb-5 mt-5">
            	...
            	<div class="col-md-8">
            		<form action="" method="post">
            			<a href="room.php" class="btn btn-primary"> Book Room </a>
            			<a href="room.php" class="btn btn-secondary"> Check Room Status </a>
            			<a href="admin_dashboard.php" class="btn btn-success"> View Users Details </a>
            			<a href="recent_checkout.php" class="btn btn-warning"> Recently Checkouts </a>
