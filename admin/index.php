...
<head>
  ...
  <style>
    body,section {background-image: url(image/about_banner.jpg);
  ...
  <section id="login_form">
    <div class="row mb-4">
      ...
      <div class="col-md-4 m-auto-block">
        ...
        <form action="index.php" method="post" class="was-validated shadow-lg p-5 bg-light">
          <div class="form-group has-success">
            <label><h5> Email: </h5></label>
            <input type="text" name="email" class="form-control" required>
            <div class="valid-feedback">Valid.</div>
            <div class="invalid-feedback" style="color:red">Please enter your name</div>
          </div>
          <div class="form-group">
            <label><h5> Password: </h5></label>
            <input type="password" name="password" class="form-control" required>
            <div class="valid-feedback">Valid.</div>
            <div class="invalid-feedback" style="color:red">Please give your password</div>
          </div>
          <button type="submit" name="admin_login" class="btn btn-success"> Login </button>
          <p><b>If You Are Not Registered, please</b><a href="registration.php"> Register Here </a></p>
        </form>
      </div>
      <div class="col-md-4"></div>
    </div>
