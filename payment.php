...
if (isset($_POST['submit'])){
    ...
    values(null,'$_POST[pay_mthd]','$_POST[card_owner]','$_POST[card_number]')";
...
<html lang="en">
    ...
    <div class="row">
      ...
      <div class="col-md-4 m-auto-block">
        ...
        <form action="payment.php" method="post" class="shadow p-4 bg-light">
          <div class="form-group">
            <p><h5>Please select your payment method:</h5></p>
            <input type="radio" id="cash" name="pay_mthd" value="CASH">
            <label for="cash">CASH</label><br>
            <input type="radio" id="card" name="pay_mthd" value="CARD">
            <label for="card">CARD</label><br>
            </div>
            <div class="form-group">
            <label><h5> Card Owner: </h5></label>
            <input type="text" name="card_owner" class="form-control">
          </div>
          <div class="form-group">
